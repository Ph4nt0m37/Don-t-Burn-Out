    ...
    extends TestCase
{
    ...
    {
        InputHandler.scanner =
            new Scanner(new ByteArrayInputStream("Hello World\n".getBytes()));
    ...
    {
        InputHandler.scanner =
            new Scanner(new ByteArrayInputStream("Yes\n".getBytes()));
    ...
    {
        InputHandler.scanner =
            new Scanner(new ByteArrayInputStream("No\n".getBytes()));
    ...
    {
        InputHandler.scanner =
            new Scanner(new ByteArrayInputStream("50\n".getBytes()));

        int result =
            InputHandler.getUserIntInput("Enter number: ", 1, 100, "Invalid!");
    ...
    {
        InputHandler.scanner =
            new Scanner(new ByteArrayInputStream("101\n50\n".getBytes()));
    ...
    public void testGetUserIntInputMultipleInvalid()
    {
        ...
        int result =
            InputHandler.getUserIntInput("Enter number: ", 0, 99, "Invalid!");
    ...
    public void testGetUserBoolInputYes()
    {
        ...
        boolean result =
            InputHandler.getUserBoolInput("Continue? ", "Invalid!");
